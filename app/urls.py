...
from .views import cliente_views, consulta_views, pet_views
...
urlpatterns = [
    ...
    path('lista_consulta/<int:id>',
         consulta_views.listar_consulta_id, name='listar_consulta_id'),
]
